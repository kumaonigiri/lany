...
?>
<style> #lp-content{ max-width: <?=esc_attr( $content_width )?> } </style>
</head>
<body>
...
?>
	...
	<?php if ( 'top' === $thumb_pos ) : ?>
		<figure class="lp-thumb">
			<?php // @codingStandardsIgnoreStart
				echo SWELL_FUNC::get_thumbnail(
					$the_id,
					[
						'sizes'       => '100vw',
						'class'       => 'lp-thumb__img',
						'placeholder' => get_the_post_thumbnail_url( $the_id, 'medium' ),
					]
				);
	...
	<div id="lp-content" class="lp-content -style-<?=esc_attr( $body_style )?>">
