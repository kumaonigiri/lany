...
// リストタイプ
$list_type = get_term_meta( $term_id, 'swell_term_meta_list_type', 1 ) ?: LIST_TYPE;
$list_type = apply_filters( 'swell_post_list_type_on_term', $list_type, $term_id );

?>
<main id="main_content" class="l-mainContent l-article">
	<div class="l-mainContent__inner">
		<?php if ( ! SWELL_FUNC::is_show_ttltop() ) : ?>
			<h1 class="c-pageTitle">
				<span class="c-pageTitle__inner">
					<?php echo SWELL_PARTS::term_title( $term_id ); ?>
				</span>
			</h1>
			<?php
				// 子ターム
				// SWELL_PARTS::the_term_children( $term_id, $wp_obj->taxonomy );
			endif;
